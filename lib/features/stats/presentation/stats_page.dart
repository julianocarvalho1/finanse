...
class _StatsPageState extends State<StatsPage> {
  ...
  Map<String, dynamic> _getCategoryStyle(String categoryName) {
    switch (categoryName) {
      ...
      default: return {'icon': Icons.more_horiz_rounded, 'color': AppColors.darkTextMuted};
    }
  }
        ...
        return SafeArea(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Container(width: 40, height: 4, decoration: BoxDecoration(color: AppColors.darkBorder, borderRadius: BorderRadius.circular(4))),
                const SizedBox(height: 16),
                const Text('Selecione o período', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700, color: AppColors.darkTextPrimary)),
                const SizedBox(height: 16),
                        ...
                        final DateTimeRange? picked = await showDateRangePicker(
                          ...
                          builder: (context, child) => Theme(
                            data: Theme.of(context).copyWith(
                              colorScheme: const ColorScheme.dark(primary: AppColors.primary, onPrimary: Colors.black, surface: AppColors.darkSurface, onSurface: AppColors.darkTextPrimary),
                            ),
                            child: child!,
                          ),
                        );
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const Icon(Icons.keyboard_arrow_down_rounded, color: AppColors.darkTextSecondary),
                  ],
                ),
              ),
            ),
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: const BoxDecoration(color: AppColors.darkSurfaceSecondary, shape: BoxShape.circle),
                      child: const Icon(Icons.pie_chart_outline_rounded, size: 48, color: AppColors.darkTextMuted),
                    ),
                    const SizedBox(height: 24),
                    const Text('Ainda não existem gastos\nneste período.', textAlign: TextAlign.center, style: TextStyle(fontSize: 16, color: AppColors.darkTextSecondary)),
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                      ...
                      children: [
                        PieChart(
                          PieChartData(
                            ...
                            sectionsSpace: 4,
                            centerSpaceRadius: 75, // O SEGREDO DO DONUT: Raio central grande!
                            sections: _categoryStats.asMap().entries.map((entry) {
                              ...
                              return PieChartSectionData(
                                ...
                                showTitle: showTitle, // DESLIGA OS < 5% DEFINITIVAMENTE
                                radius: isTouched ? 45.0 : 35.0, // A fatia cresce se tocada
                        ...
                        Column(
                          mainAxisSize: MainAxisSize.min,
                          children: [
                            const Text('Total', style: TextStyle(fontSize: 14, color: AppColors.darkTextSecondary)),
                            Text(
                          ...
                          Row(
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  Text(currencyFormatter.format(_categoryStats[_touchedIndex].amount), style: const TextStyle(fontSize: 24, fontWeight: FontWeight.w700, color: AppColors.darkTextPrimary)),
                                  const SizedBox(height: 4),
                                  Text('${_categoryStats[_touchedIndex].count} lançamentos', style: const TextStyle(fontSize: 13, color: AppColors.darkTextSecondary)),
                                ],
                              ),
                              Container(
                  ...
                  const Text('Top Despesas', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: AppColors.darkTextPrimary)),
                  const SizedBox(height: 16),
                    ...
                    return Padding(
                      ...
                      child: Row(
                        children: [
                          Container(
                            width: 48, height: 48,
                            decoration: BoxDecoration(color: stat.style['color'].withOpacity(0.15), borderRadius: BorderRadius.circular(16)),
                          ...
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text(stat.name, style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w600, color: AppColors.darkTextPrimary)),
                                const SizedBox(height: 2),
                                Text('${stat.percentage.toStringAsFixed(1)}%', style: const TextStyle(fontSize: 13, color: AppColors.darkTextSecondary)),
                              ],
                            ),
                          ),
                          Text(currencyFormatter.format(stat.amount), style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w600, color: AppColors.darkTextPrimary)),
                        ],
                      ),
                    );
                  }),
