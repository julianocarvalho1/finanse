  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Backup e Restauração', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 20, color: textPrimary)),
        centerTitle: true,
      ),
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
                ...
                border: Border.all(color: isDark ? primaryColor.withOpacity(0.3) : borderColor),
            ...
            child: Column(
              children: [
                ...
                Text('Último backup realizado:', style: TextStyle(color: textMuted, fontSize: 14)),
                const SizedBox(height: 8),
                Text(_lastBackupDate, style: TextStyle(color: textPrimary, fontSize: 18, fontWeight: FontWeight.w700)),
                const SizedBox(height: 32),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: _isBackingUp
                        ...
                        : const Text('Fazer backup agora', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w700)),
                  ),
                ),
              ],
            ),
          ...
          OutlinedButton.icon(
            ...
            label: Text('Restaurar backup antigo', style: TextStyle(color: textSecondary)),
